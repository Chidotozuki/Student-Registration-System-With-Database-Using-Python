...
Label(studentInfo, text="First Name:", font="arial 13", bg=frameBg, fg=frameFg).place(
    x=30, y=50
)
Label(studentInfo, text="Middle Name:", font="arial 13", bg=frameBg, fg=frameFg).place(
    x=30, y=100
)
Label(studentInfo, text="Last Name:", font="arial 13", bg=frameBg, fg=frameFg).place(
    x=30, y=150
)

Label(studentInfo, text="Level:", font="arial 13", bg=frameBg, fg=frameFg).place(
    x=500, y=50
)
Label(studentInfo, text="Department", font="arial 13", bg=frameBg, fg=frameFg).place(
    x=500, y=100
)
Label(
